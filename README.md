...
### 專案介紹
這是一個致力於整合與規劃「長者資源」的開源專案。我們的目標是打造一個友善的工具，讓長者及其照護者能夠更輕鬆地獲取必要的服務、醫療資訊與社區支持。
...
### Introduction
This project is an open-source initiative dedicated to integrating and organizing resources for the elderly. Our mission is to build a user-friendly tool that helps seniors and their caregivers easily access essential services, medical information, and community support.

    ...
    <main className="min-h-screen px-5 py-10" style={{ background: "#FFFBF5" }}>
      <div className="mx-auto max-w-2xl">
        ...
        <form action={action} className="mt-8 space-y-6">
          {/* 標題 */}
          <div>
            <label className="block text-xl font-semibold" style={{ color: "#1C1917" }}>
              問題標題 <span style={{ color: "#DC2626" }}>*</span>
            </label>
            <input
              name="title"
              type="text"
          ...
          <button
            type="submit"
            disabled={pending}
            className="w-full rounded-2xl py-5 text-2xl font-bold text-white transition disabled:opacity-60"

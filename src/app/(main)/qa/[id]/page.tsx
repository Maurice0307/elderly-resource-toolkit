  ...
  return (
    <main className="min-h-screen px-5 py-10" style={{ background: "#FFFBF5" }}>
      <div className="mx-auto max-w-3xl">
        <Link href="/qa" className="text-lg font-medium" style={{ color: "#B45309" }}>
          ← 回問答區
        </Link>

        {/* 問題 */}
        <article
          className="mt-6 rounded-2xl bg-white p-8"
        ...
        >
          ...
          <h1 className="mt-4 text-3xl font-bold leading-snug" style={{ color: "#1C1917" }}>
            {q.title}
          </h1>

          {q.body && (
            <p className="mt-4 text-xl leading-relaxed whitespace-pre-line" style={{ color: "#44403C" }}>
              {q.body}
            </p>
          )}

          <p className="mt-5 text-base" style={{ color: "#A8A29E" }}>
        ...
        {/* 回答表單 */}
        <section className="mt-10 border-t pt-8" style={{ borderColor: "#E7E5E4" }}>
          <h2 className="text-2xl font-bold" style={{ color: "#1C1917" }}>
            留下你的回答
          </h2>
          {user ? (
            ...
            <div className="mt-4 rounded-2xl p-6 text-center text-xl" style={{ background: "#FEF3C7", color: "#92400E" }}>
